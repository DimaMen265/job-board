...
export default function Dashboard() {
    ...
    // Redirect to login if applicant data is undefined
        ...
        <div>
            ...
            <div className="filter_">
                ...
                <div className="filter2_">
                    ...
                    <hr />
                    {
                        openJob && openJob.length > 0 && openJob.map((list, i) => {
            ...
            <div className="job2">
                <br /><br />
                {
                    Applicant && Applicant.length > 0 && Applicant.map((list, i) => {
                                    ...
                                    <div>
                                        <div className="detaills_">
                                            ...
                                            <div className="description">
                                                ...
                                                <textarea style={{ borderWidth: '0px' }} readOnly id="" cols="70" rows="3">{list.attributes.Message}</textarea>
            ...
            <div className="filt">
                ...
                <div className="filter2_">
                    ...
                    <form className="filter3_" method="get">
                        ...
                        <br />
                        <textarea onChange={(event) => setjobDescription(event.target.value)} style={{ width: '200px', borderRadius: '10px' }} placeholder="Job description"></textarea>
                        <br />
                        <select onChange={(event) => setjobExperience(event.target.value)} className="select">
                            <option disabled selected>Requirement</option>
                            <option value="Experience : 1 - 3 years">Experience : 1 - 3 years</option>
